      ...
      <div onClick={onClick} className="relative w-full overflow-hidden rounded-[2.5rem] bg-white flex flex-col md:flex-row shadow-2xl group cursor-pointer h-full min-h-[500px] md:h-[550px]">
        ...
        <div className="w-full md:w-[40%] p-6 md:p-8 lg:p-10 bg-editorial-red text-white flex flex-col justify-center overflow-hidden transition-colors duration-500 group-hover:bg-[#a6e076]">
          <div className="space-y-4">
            ...
            <p className="text-sm md:text-base opacity-90 font-medium leading-snug line-clamp-3 md:line-clamp-4 lg:line-clamp-6 group-hover:text-black">
              {article.excerpt}
            </p>
          </div>
          ...
          <div className="mt-8 flex items-center gap-3 border-t border-white/20 pt-6 group-hover:border-black/10">
            <div className="flex flex-col">
              <span className="text-[10px] font-black uppercase tracking-[0.2em] border-b-2 border-white group-hover:border-black group-hover:text-black inline-block w-fit mb-1">
                DI {article.author.toUpperCase()}
              </span>
              <span className="text-[10px] font-black uppercase tracking-widest opacity-60 group-hover:text-black group-hover:opacity-40">
    ...
    return (
      <div onClick={onClick} className="relative w-full aspect-[4/5] overflow-hidden rounded-[2.5rem] group cursor-pointer shadow-xl bg-black shrink-0">
        ...
        <div className="absolute bottom-0 left-0 p-8 w-full">
           <span className="bg-editorial-red text-white px-3 py-1 rounded text-[10px] font-black uppercase tracking-widest mb-4 inline-block transition-colors group-hover:bg-[#c0ff8c] group-hover:text-black">
             {article.category}
           </span>
  ...
  return (
    <div onClick={onClick} className="flex flex-col group cursor-pointer h-full transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl hover:bg-white rounded-[2rem] p-4 -m-4">
      ...
      <div className="flex flex-col flex-1">
        <span className="text-editorial-red text-[9px] font-black uppercase tracking-[0.15em] mb-2 block transition-colors group-hover:text-[#a6e076]">
          {article.category}
        </span>
