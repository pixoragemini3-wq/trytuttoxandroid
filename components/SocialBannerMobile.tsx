...
const SocialBannerMobile: React.FC = () => {
  const platforms = [
  ...
  return (
    <div className="lg:hidden w-full relative overflow-hidden py-5 px-6 border-b border-gray-100 bg-yellow-400 mb-8 mt-6 shadow-sm">
